...
impl HelloService for MockHelloService {
    async fn say_hello(&self, _request: Request<()>) -> Result<Response<SayHelloResponse>, Status> {
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let hello_service = MockHelloService;
    ...
    println!("📁 Descriptor file at: {out_dir}/*/out/services_descriptor.bin");
